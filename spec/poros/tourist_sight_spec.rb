...
RSpec.describe 'TouristSight PORO' do
  it 'can retrieve the necessary info' do
    data = { type: 'Feature',
             properties: { name: "Tour de l'horloge",
                           ...
                           datasource: { sourcename: 'openstreetmap',
                                         ...
                                         raw: { url: 'http://en.wikipedia.org/wiki/File:Aubusson_tour_de_l_horloge.JPG',
    ...
    expect(sight.instance_variables).to eq(%i[@name @address @place_id])
